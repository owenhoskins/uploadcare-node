    ...
    res.on('end',
        function() {
          ...
          try {
              ...
              return callback(new Error(util.format('Invalid JSON from uploadcare.com: %s', response, e)));
          }
    ...
    var api = {
        file: {
            ...
            fromUrl: function(fileUrl, options, callback) {
                ...
                if (options.check_URL_duplicates === true) {
                    form.append( 'check_URL_duplicates', 1 )
                } else {
                    form.append( 'check_URL_duplicates', 0 )
                }
                if (options.save_URL_duplicates === true) {
                    form.append( 'save_URL_duplicates', 1 )
                } else {
                    form.append( 'save_URL_duplicates', 0 )
                }
